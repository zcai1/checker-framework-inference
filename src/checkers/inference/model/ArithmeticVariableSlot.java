...
// * ArithmeticVariableSlot for the same three components will give back the same
...
//            return this.operation == other.operation && this.leftOperand.equals(other.leftOperand)
